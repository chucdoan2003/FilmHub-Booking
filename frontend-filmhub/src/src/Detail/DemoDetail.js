      ...
      <div className="movie-details-wrap section-ptb-50 bg-black grid grid-cols-12">
        <div className="container col-span-7">
          <div className="movie-details-video-content-wrap grid grid-cols-12 gap-3 mb-4">
            <div className="video-wrap col-span-4 text-white">
            ...
            <div className="movie-details-info col-span-8 text-white">
              <ul>
                <li>
                  <span>Director: </span>
              ...
              {/* <div className="">
                <button
                  className="w-40 bg-red-500 text-center text-white font-medium rounded-md my-3"
                  onClick={toggleVideo}
                >
