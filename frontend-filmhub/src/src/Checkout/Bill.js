...
const Bill = () => {
  ...
  const { selectedSeats, totalPrice, user } = location.state || {};
    ...
    <div className="container">
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-8 m-4">
          ...
          <h3 className="text-xl my-4 text-white">Tên Phim: Example Movie</h3>
          <p className="my-2 text-white">Địa điểm: Cinema XYZ</p>
          <p className="my-2 text-white">Ngày chiếu: 25/12/2023 - 10:00 AM</p>
          ...
          <div className="flex flex-row">
            ...
            <div className="text-white">{selectedSeats.join(", ")}</div>
          </div>
