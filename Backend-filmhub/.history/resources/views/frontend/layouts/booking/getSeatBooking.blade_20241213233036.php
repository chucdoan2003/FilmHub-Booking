...
@section('content')
    ...
    <!-- st top header Start -->
    @if($bookingTimeLimit)
    <div id="booking-timer" class="text-center text-red-500 font-bold text-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Lấy thời gian đặt vé từ server (nếu có)
        let bookingTimeLimit = {{ $bookingTimeLimit ?? 'null' }};
        ...
        if (bookingTimeLimit) {
            ...
            let countdown = setInterval(function () {
                ...
                // Hết thời gian, chuyển về trang chủ
