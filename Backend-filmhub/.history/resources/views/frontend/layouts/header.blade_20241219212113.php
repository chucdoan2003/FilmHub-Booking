                        ...
                        <ul class="dl-menu">
                            ...
                            <li class="parent logout-btn">
                                <a href="javascript:void(0)"
                                    ...
                                    class="button button--tamaya" data-text="Log out">
                                    <span>Log out</span>
                                </a>
                            </li>
                        @else
                            <li class="login-btn">
                                <a href="{{ route('getLogin') }}" class="button button--tamaya" data-text="Sign in">
                                    <span>Sign in</span>
                                </a>
                            </li>
                            <li class="login-btn"><a href="{{ route('userOverview') }}" class="button button--tamaya">OVERVIEW</a>
                            </li>
                            <li class="login-btn"><a href="{{ route('ticketHistory') }}" class="button button--tamaya">TICHKETS BOOKED</a>
                            </li>
                            @endif
