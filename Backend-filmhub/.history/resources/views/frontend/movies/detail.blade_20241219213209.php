...
{{-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"> --}}
    ...
    <div class="prs_ms_trailer_vid_main_wrapper ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12 d-flex justify-content-center" style="display: flex; justify-content:center;">
                    <div class="item">
                    ...
                    <div class="prs_ms_trailer_slider_right_wrapper">
                        ...
                        <!-- Phần đánh giá sao -->
                        <div class="star-rating mb-3 mt-2" style="direction: ltr; margin:20px 0px !important; margin-right:190px !important;">
                            @for ($i = 1; $i <= 5; $i++)
                        ...
                        <div class="mt-4 text-center">
                            <a class="text-white bg-danger py-2 px-5 rounded" href="/booking/{{ $movie->movie_id }}" style="background-color: red; color:white; padding: 8px 20px; border-radius: 999px ; margin-right:190px;">Đặt
                                vé ngay</a>
                        </div>
                    </div>
                </div>
