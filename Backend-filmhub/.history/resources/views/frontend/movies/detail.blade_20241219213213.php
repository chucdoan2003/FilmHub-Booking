                ...
                <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12 d-flex justify-content-center" style="display: flex; justify-content:center;">
                    ...
                    <div class="prs_ms_trailer_slider_right_wrapper">
                        ...
                        <div class="mt-4 text-center">
                            <a class="text-white bg-danger py-2 px-5 rounded" href="/booking/{{ $movie->movie_id }}" style="background-color: red; color:white; padding: 8px 20px; border-radius: 999px ; margin-right:180px;">Đặt
                                vé ngay</a>
                        </div>
                    </div>
                </div>
