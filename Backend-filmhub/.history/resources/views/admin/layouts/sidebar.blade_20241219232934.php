        ...
        @if (Auth::user()->status == 'admin')
            ...
            <li class="nav-item">
                ...
                <div id="collapseVourchers" class="collapse" aria-labelledby="headingOrders"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('vourchers.index') }}">Danh sách mã giảm giá </a>
                        <a class="collapse-item" href="{{ route('vourcher-events.index') }}">Danh sách mã giảm giá sự kiện </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseComment" class="collapse" aria-labelledby="headingMovies"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Danh sách chức năng </h6>
                        <a class="collapse-item" href="{{ route('admin.comments.index') }}">Danh sách bình luận </a>
                    </div>
                </div>
            </li>
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTicket" class="collapse" aria-labelledby="headingMovies"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Chức năng </h6>
                        <a class="collapse-item" href="{{ route('admin.tickets.index') }}">Danh sách vé</a>
                    </div>
                </div>
            </li>
