...
class ClientBookingController extends Controller
{
    ...
    public function getSeatBooking($showtime_id)
    {
        ...
        if ($currentDateTime->diffInMinutes($showtimeStart, false) <= 10) {
            return redirect()->route('movies.index')->with('error', 'Sắp đến giờ chiếu nên sẽ đóng đặt vé trực tuyếntuyến, vui lòng mua vé trực tiếp tại quầy hoặc chọn ca chiếu khác.');
        }
