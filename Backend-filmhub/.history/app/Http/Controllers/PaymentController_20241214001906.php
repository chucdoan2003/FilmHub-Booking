...
class PaymentController extends Controller
{
    public function vnpay_payment(Request $request)
    {
        ...
        foreach ($selectedSeats as $seatId) {
            $seatExists = \DB::table('selected_seatss')->where('seat_id', $seatId)->exists();
            if (!$seatExists) {
                return redirect()->route('getSeatBooking', $showtimeId)->with('error', 'Vui lòng chọn lại ghế do quá thời giangian');
            }
        }
