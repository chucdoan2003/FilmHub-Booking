...
Route::post('showtime/find', [ShowTimesController::class,'findShowtime'])->name('findShowtime');
...
Route::prefix('admin/statistics')->group(function () {
    ...
    Route::get('/statistics/filmTheat   er/{theater_id}/{movie_id}', [StatisticController::class, 'statisticFilmTheater'])->name('admin.statistics.statisticFilmTheater');
