...
CKEDITOR.dialog.add("cellProperties", function (g) {
    ...
    var q = g.lang.table, d = q.cell, e = g.lang.common, p = CKEDITOR.dialog.validate, z = "rtl" == g.lang.dir,
        m = g.plugins.colordialog, l = t("width"), A = t("height"), B = k(["td{width}", "td{height}"]), C = {
            type: "select",
            id: "wordWrap",
            ...
            label: d.hAlign,
            "default": "",
            items: [[e.notSet, ""], [e.left, "left"], [e.center, "center"], [e.right, "right"], [e.justify, "justify"]],
            setup: f(function (a) {
            ...
            label: d.vAlign,
            "default": "",
            items: [[e.notSet, ""], [e.alignTop, "top"], [e.alignMiddle, "middle"], [e.alignBottom, "bottom"], [d.alignBaseline, "baseline"]],
            setup: f(function (a) {
        ...
        }, G = k(["td{text-align}", "td{vertical-align}"]), H = d.cellType, x;
    x = g.config.tabletools_scopedHeaders ? [[d.data, "td"], [d.columnHeader, "thc"], [d.rowHeader, "thr"]] : [[d.data, "td"], [d.header, "th"]];
    var l = [l, A, B, C, D, E, F, G, {
        type: "select",
        id: "cellType",
        ...
        children: function () {
            var a = [{
                type: "text", id: "bgColor", label: d.bgColor, "default": "", setup: f(function (a) {
        ...
        children: function () {
            var a = [{
                type: "text", id: "borderColor", label: d.borderColor, "default": "", setup: f(function (a) {
    ...
    }], n = 0, y = -1, h = [r()], l = CKEDITOR.tools.array.filter(l, function (a) {
    ...
    return {
        ...
        contents: [{
            ...
            label: d.title,
            accessKey: "I",
            elements: [{type: "hbox", widths: 1 === h.length ? ["100%"] : ["40%", "5%", "40%"], children: h}]
        }],
        getModel: function (a) {
        ...
        onOk: function () {
            for (var a = this._.editor.getSelection(),
                     b = a.createBookmarks(), c = this.getParentEditor(), d = this.getModel(c), e = 0; e < d.length; e++) this.commitContent(d[e]);
