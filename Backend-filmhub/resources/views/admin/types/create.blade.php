...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Tạo mới loại ghế</h1>
        <!--  Page main content   -->
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="#collapseProductInfo" class="d-block card-header py-3" data-toggle="collapse"
                           role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <h6 class="m-0 font-weight-bold text-primary">Thông tin chính của loại ghế</h6>
                        </a>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="type_name"
                                           placeholder="Vui lòng nhập tên loại ghế">
                                    @error('type_name')
