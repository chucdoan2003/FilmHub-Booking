...
@section('content')
    <form action="{{ route('admin.movies.update', $movie->movie_id) }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mb-4">
            ...
            <select id="genres" name="genres[]" class="selectpicker form-control" disabled multiple data-live-search="true">
        ...
        <div class="mb-3">
            ...
            <input type="file" id="imageInput" name="poster_url" disabled id="poster_url">
