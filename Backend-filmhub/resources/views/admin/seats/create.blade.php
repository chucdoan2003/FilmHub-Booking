                            ...
                            <div class="card-body">
                                ...
                                <select class="form-control" aria-label="Default select example" id="choices-category-input"
                                    ...
                                    @foreach ($rows as $row)
                                        <option value="{{ $row->row_id }}">
                                            {{ $row->row_name }} - Phòng: {{ $row->room->room_name ?? 'Không có phòng' }}
                                            - Rạp: {{ $row->room->theater->name ?? 'Không có rạp' }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('row_id')
                                ...
                                <div class="form-group custom-control custom-radio small d-flex ">
                                    @foreach ($types as $key => $value)
                                        <div class="col-md-3">
                                            <input type="radio" class="custom-control-input" value="{{ $key }}"
                                                name="type_id" id="customCheck-{{ $key }}">
