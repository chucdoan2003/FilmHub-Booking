        ...
        <form action="{{ route('banner.store') }}" method="POST" class="user" enctype="multipart/form-data" >
            ...
            @method("POST")
                <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <input type="text" class="form-control form-control-user form-radius" placeholder="Avt..." name="name">
                        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div
                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
<<<<<<< HEAD:Backend-filmhub/resources/views/admin/showtimes/add.blade.php
                        <h6 class="m-0 font-weight-bold text-primary">Theaters</h6>
=======
                        <h6 class="m-0 font-weight-bold text-primary">Image</h6>
>>>>>>> c34dbe889404f10f96635ee1e20595a13ffb06b5:Backend-filmhub/resources/views/admin/banner/create.blade.php
                    </div>
