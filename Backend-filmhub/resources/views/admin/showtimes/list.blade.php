                    ...
                    <tbody>
                        @foreach ($showtimes as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('showtimes.edit', $item->showtime_id) }}"><button
                                            class="btn-warning">Edit</button></a>
                                    <form action="{{ route('showtimes.destroy', $item->showtime_id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn-danger"
                                            onclick="return confirm('Do you want to delete this showtime ?')">Delete</button>
