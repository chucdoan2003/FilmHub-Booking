            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <input type="date" class="form-control form-control-user form-radius" name="datetime"  @if(isset($datetime)) value="{{$datetime}}" @endif value="{{ Carbon::now()->format('Y-m-d') }}" id="datetime" >
