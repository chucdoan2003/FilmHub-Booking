...
@section('content')
    <div class="container mt-5">
        <h1>Ví Mã Giảm Giá</h1><br>
        <a href="{{ route('redeem.form') }}" class="btn btn-primary mt-3">Đổi Voucher</a><br><br>
        ...
        <h2 class="mt-5">Danh sách mã giảm giá sự kiên</h2><br>
        <table class="table table-bordered table-striped table-hover mt-4">
            ...
            <tbody>
                ...
                @if (\Carbon\Carbon::now()->between($event->start_time, $event->end_time))
                <tr>
