...
<form action="{{route('vnpay_payment')}}" method="post" enctype="multipart/form-data" id="payment-form">
    ...
    <input type="hidden" name="selected_seats" value="{{ implode(', ', $selectedSeatsArray) }}">
    <!-- st top header Start -->
                            ...
                            <div class="col-md-12">
                                <div class="st_dtts_ineer_box float_left">
                                    <ul>
                                        ...
                                        <li><span class="dtts1">Ghế đã chọn:</span> <span class="dtts2">{{ implode(', ', $selectedSeatsArray) }}</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="st_dtts_bs_wrapper float_left">
                                ...
                                <div class="st_dtts_sb_ul float_left">
                                    <ul>
                                        <li>{{ implode(', ', $selectedSeatsArray) }}<br>({{ count($selectedSeatsArray) }} Tickets) <span>Giá: {{ number_format($totalPrice)}} VNĐ</span></li>
