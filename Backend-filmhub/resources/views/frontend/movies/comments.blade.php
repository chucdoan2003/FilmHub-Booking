    ...
    <form class="" action="{{ route('comments.store', ['movie_id' => $movie->movie_id]) }}" method="POST">
        ...
        <div class="comment-box">
            <div class="d-flex mb-1">
                <img src="{{Storage::url(Auth::user()->avt) ?? ''}}" alt="Avatar" style="margin-left: 50px" class="rounded-circle"
                    width="50" height="50">
                <!-- Star Rating -->
            ...
            <!-- Submit Button -->
            <br>
            <button type="submit" class="btn btn-success" id="submit-comment">Gửi </button>
        </div>
    </form>
</div>
        ...
        @foreach ($comments as $comment)
            <div class="card mt-2 comment-item">
                <div class="card-body d-flex">
                    ...
                    <img src="{{Storage::url(Auth::user()->avt)}}" alt="Avatar"
