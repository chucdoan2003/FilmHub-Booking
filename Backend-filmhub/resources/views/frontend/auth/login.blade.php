        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                @if (isset($isLogin) && $isLogin == true)
                    <div>
                        <h2 style="font-size: 20px">Login successfully <button type="button" class="btn-login"><a href="{{route("getLogin")}}" style="color: #fff">Home</a></button> </h2>
                    </div>
                        
                @else 
                    @if (isset($isLogin) && $isLogin == false)
                        <div>
                            <h2 style="font-size: 20px">Email or Password is incorrect !! 
                                <a href="{{route("getLogin")}}" style="color: #fff">
                                <button type="button" class="btn-login">Try Again !</button> 
                                </a>
                            </h2>
                        </div>
                    @else
